...
public class TestFuncionalidades {
	...
	static {
		...
		new Camion("SS", "vehiculos.Camion premium", 1000, 100, f1, 3);
		new Camion("AA", "vehiculos.Camion", 1000, 100, f1, 3);
		...
		new Camion("SS", "vehiculos.Camion premium", 1000, 100, f3, 3);
		new Camion("AA", "vehiculos.Camion", 1000, 100, f3, 3);
